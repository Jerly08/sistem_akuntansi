...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.PaginatedJournalResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "services.JournalResponse": {
            ...
            "properties": {
                ...
                "lines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.JournalLineResponse"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "services.PaginatedJournalResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
