...
const { API_ENDPOINTS } = require('./frontend/src/config/api');
...
purchaseEndpoints.forEach(endpoint => {
  if (API_ENDPOINTS[endpoint] !== undefined) {
    console.log(`✓ ${endpoint}:`, typeof API_ENDPOINTS[endpoint] === 'function' 
      ? API_ENDPOINTS[endpoint](123) // Test function endpoints with ID 123
